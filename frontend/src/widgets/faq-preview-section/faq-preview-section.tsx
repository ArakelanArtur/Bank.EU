...
import { ChevronDown, UserCheck, Clock, SearchX } from 'lucide-react';
...
const FAQS = [
  {
    ...
    a: 'Любой совершеннолетний резидент страны присутствия сервиса с действующим удостоверением личности и зарегистрированным номером телефона.',
  },
  {
    icon: Clock,
    q: 'Как быстро я получу деньги?',
    a: 'Заявки рассматриваются в течение нескольких минут. После одобрения деньги переводятся сразу.',
  },
  {
    icon: SearchX,
